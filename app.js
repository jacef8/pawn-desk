...
const CH_AGE={label:"Age",options:[
  {t:"Under 3 yr",m:1},
  {t:"4–6 yr",m:.6,note:"4-6 years old: −40%"},
  {t:"Older",m:.4,note:"aged electronics — accessory money"}]};
...
const SPEC_CHOICES={
 ...
 g8:[CH_CALIBER,{label:"Barrel",options:[{t:"3–6 in",m:1},{t:"Snub 2 in",m:1},{t:"8 in + hunter",m:.9,note:"long hunter barrel — narrower market: −10%"}]}],
 g9:[{label:"Type",options:[{t:"In-line (modern)",m:1},{t:"Sidelock / traditional",m:.8,note:"traditional — thin buyer pool: −20%"}]},CH_OPTIC],
 p1:[{label:"Bar length",options:[{t:"16–18 in",m:1},{t:"20 in +",m:1.15,note:"pro-length bar: +15%, slower buyer"}]},CH_GRADE],
 ...
 p4:[{label:"Drive",options:[{t:"Gas push",m:1},{t:"Self-propelled",m:1.15,note:"self-propelled: +15%"},{t:"Battery — with battery",m:.9,note:"battery mower: −10%"},{t:"Corded electric",m:.5,note:"corded: about half"}]},
     {label:"Deck",options:[{t:"21 in",m:1},{t:"30 in wide-area",m:1.2,note:"wide-area: +20%"}]}],
 p5:[{label:"Deck",options:[{t:"42 in",m:1},{t:"46–54 in",m:1.15,note:"bigger deck: +15%"},{t:"30s-class",m:.85,note:"small deck: −15%"}]},
 ...
 p6:[{label:"Power",options:[{t:"Gas",m:1},{t:"Electric",m:.6,note:"electric washer: −40%"}]},
     {label:"Pressure",options:[{t:"2,500–3,200 PSI",m:1},{t:"Under 2,000",m:.8,note:"light duty: −20%"},{t:"4,000 +",m:1.2,note:"commercial PSI: +20%"}]}],
 ...
 t3:[{label:"Power",options:[{t:"Corded",m:1},{t:"Cordless — with battery",m:1.1,note:"cordless w/ battery: +10%"},{t:"Cordless — bare",m:.6,note:"bare tool: −40%"}]},
     {label:"Size",options:[{t:"4.5 in",m:1},{t:"7–9 in",m:1.15,note:"big grinder: +15%"}]}],
 t4:[{label:"Size",options:[{t:"Pancake 6 gal",m:1},{t:"Mini 2–3 gal",m:.8,note:"small tank: −20%"}]},
 ...
 t6:[{label:"Setup",options:[{t:"110V, gas-ready MIG",m:1},{t:"Flux-core only",m:.8,note:"flux-only: −20%"},{t:"220/240V",m:1.25,note:"220V unit: +25%"}]},
     {label:"Duty",options:[{t:"Hobby (140A class)",m:1},{t:"200A +",m:1.2,note:"heavy duty: +20%"}]}],
 ...
 e1:[{label:"Screen size",options:[{t:"50–65 in",m:1},{t:"70 in +",m:1.4,note:"big screen: +40%"},{t:"Under 43 in",m:.5,note:"small screen: about half"}]},
     {label:"Age",options:[{t:"Under 2 yr",m:1},{t:"3–5 yr",m:.7,note:"3-5 years: −30%"},{t:"Older",m:.5,note:"old panel: half"}]}],
 e2:[CH_AGE,{label:"Class",options:[{t:"Standard",m:1},{t:"Gaming / workstation",m:1.3,note:"gaming class: +30%"}]}],
 e3:[CH_AGE],
 e4:[{label:"Age",options:[{t:"Under 2 yr, flagship-class",m:1},{t:"3–4 yr",m:.6,note:"3-4 years old: −40%"},{t:"5 yr +",m:.4,note:"old phone — accessory money"}]},
 ...
 m3:[{label:"Type",options:[{t:"Solid-state",m:1},{t:"Tube amp",m:1.3,note:"tube amp: +30%"}]},
     {label:"Size",options:[{t:"Practice (under 30W)",m:1},{t:"Gigging (50W +)",m:1.2,note:"gig-size: +20%"}]}],
...
document.addEventListener("click",e=>{
  ...
  const u=prompt("Address of the shop's price service:",pdServer()||"https://");
  if(u===null)return;
...
const SPEC_AUTO=[
 ...
 {g:"Pressure",re:/\b([4-9],?\d{3})\s*psi\b/,o:"4,000 +"},{g:"Pressure",re:/\b(1,?\d{3}|\d{3})\s*psi\b/,o:"Under 2,000"},
 {g:"Screen size",re:/\b(7\d|8\d|98|100)\s*(in|inch|")/,o:"70 in +"},{g:"Screen size",re:/\b(24|32|40|42)\s*(in|inch|")/,o:"Under 43 in"}];
