...
const C="pawndesk-202609211815";
const CORE=["./","./index.html","./phone.html","./app-head.js","./app.css","./app.js","./prices.json","./fakes.json","./phone.css","./phone.js","./manifest.webmanifest","./manifest-phone.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
